  ...
  return (
    <div className="mx-auto max-w-4xl px-4">
      ...
      <section className="flex flex-col items-center gap-6 py-16 text-center">
        <div className="relative h-40 w-40 overflow-hidden rounded-full border-4 border-brand-yellow bg-brand-navy/20">
          <Image
            ...
            alt="Nhân vật Ổn Mà, Từ Từ - mỉm cười nhẹ nhàng"
            fill
        ...
        <p className="max-w-xl text-foreground/70">{siteConfig.description}</p>
      ...
      <section className="py-8">
        <h2 className="mb-6 text-xl font-semibold">Câu chuyện mới nhất</h2>
        {posts.length === 0 ? (
          <p className="text-foreground/60">
            Chưa có bài viết nào. Thêm file .mdx vào{" "}
            <code>content/blog</code> để bắt đầu.
          </p>
        ) : (
