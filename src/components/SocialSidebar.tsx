...
export function SocialSidebar() {
  return (
    <div className="fixed left-4 top-1/2 -translate-y-1/2 z-40 flex-col gap-3 hidden sm:flex">
      {socials.map(({ label, href, icon }) => (
        <a
          ...
          className="
            ...
            hover:bg-brand-yellow hover:text-foreground hover:border-brand-yellow
            hover:translate-x-1
